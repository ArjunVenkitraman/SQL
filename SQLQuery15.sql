...
-- 1) AUTO COMMIT AND AUTO ROLL BACK IS NOTHING BUT A PREDEFINED COMPLETE STATEMENT AND PREDEFINED ERROR SATEMENT IF COMMIT DOESN'T WORK ROLLBACK EXECUTES
...
--IF WE TURN ON IMPLICITE TRANSACTION THEN IF TRANSACTION SUCCESSFULL THEN TRANCOUNT 1 AND COMMIT
